"""
쿠팡 로켓배송 발주 수집·박스라벨 출력 프로그램 v6.04
=======================================================
[프로그램 개요]
...
class Constants:
    ...
    DIR_PATHS = [
        ...
        r"D:\hSync\Coding",          # 개발자 로컬 경로 (우선순위 3)
    ]
    ...
    # ── GUI 스타일 상수 ──
    WINDOW_TITLE    = "쿠팡로켓 발주 수집·박스라벨 출력 프로그램 v6.06"
        ...
        try:
            ...
            for box_no, group in groups:
                ...
                ws.cell(offset_row + Constants.BOX_ROW_OFFSET_ORDER,
                        Constants.BOX_COL_ORDER_VALUE).value = first['발주번호']
